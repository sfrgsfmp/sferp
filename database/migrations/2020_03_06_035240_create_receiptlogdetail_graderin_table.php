...
class CreateReceiptlogdetailGraderinTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receiptlogdetail_graderin', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('receiptlogdetail_graderin');
    }
}
