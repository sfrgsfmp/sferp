...
<div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong>@yield('content_title_active','Create Job Order')</strong>
        </li>
    </ol>
</div>
<div class="col-lg-2">
                            ...
                            <div class="row">        
                                <div class="col-sm-9">
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('Job Order No') is-invalid @enderror" id="jo" name="jo">
                                            @error('Job Order No')
                           ...
                           <div class="row">
                                <div class="col-sm-6 b-r">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="pimno" name="pimno" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="po_reference" name="po_reference" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="spec1" name="spec1" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="sortimen" name="sortimen" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="kodefsc" name="kodefsc" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="typetransport" name="typetransport" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="notransport" name="notransport" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="estdocm3" id="estdocm3" class="form-control @error('estdocm3') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('estdocm3')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="etadate" id="etadate" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="parcel" id="parcel" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="species" id="species" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="measurement" id="measurement" class="form-control" readonly> </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="document" id="document" class="form-control" readonly> </textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="contractor" name="contractor" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="tuk" name="tuk" class="form-control @error('TUK') is-invalid @enderror">
                                            @error('TUK')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="instruksilain" name="instruksilain" class="form-control @error('instruksilain') is-invalid @enderror"> </textarea>
                                            @error('instruksilain')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <select id="identitas" name="identitas" class="form-control @error('Identitas') is-invalid @enderror">
                                                <option value="Log Tag"> Log Tag</option>
                                                <option value="Kitir KK"> Kitir KK</option>
                                            </select>
                                            @error('Identitas')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="tebalfisik" id="tebalfisik" class="form-control @error('Tebal Fisik') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Tebal Fisik')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="lebarfisik" id="lebarfisik" class="form-control @error('Lebar Fisik') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Lebar Fisik')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="panjangfisik" id="panjangfisik" class="form-control @error('Panjang Fisik') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Panjang Fisik')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="descfisik" name="descfisik" class="form-control @error('Deskripsi Fisik') is-invalid @enderror"> </textarea>
                                            @error('Deskripsi Fisik')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="tebalbeli" id="tebalbeli" class="form-control @error('Tebal Beli') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Tebal Beli')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="lebarbeli" id="lebarbeli" class="form-control @error('Lebar Beli') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Lebar Beli')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="panjangbeli" id="panjangbeli" class="form-control @error('Panjang Beli') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Panjang Beli')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="descbeli" name="descbeli" class="form-control @error('Deskripsi Beli') is-invalid @enderror"> </textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="tebalinvoice" id="tebalinvoice" class="form-control @error('Tebal Invoice') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Tebal Invoice')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="lebarinvoice" id="lebarinvoice" class="form-control @error('Lebar Invoice') is-invalid @enderror" onkeypress="return isNumber(event)">
                                            @error('Lebar Invoice')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="panjanginvoice" id="panjanginvoice" class="form-control @error('Panjang Invoice') is-invalid @enderror" onkeypress="return isNumber(event)">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="descinvoice" name="descinvoice" class="form-control @error('Deskripsi Invoice') is-invalid @enderror"> </textarea>
                            ...
                            <div class="row">
                                ...
                                <h4 class="m-t-none m-b">Quality</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <select id="warnaterang" name="warnaterang" class="form-control @error('Warna Terang') is-invalid @enderror">
                                                <option value=""> </option>
                                                @foreach($quality as $qty)
                                                    <option value="{{$qty->id}}"> {{$qty->quality_name}}</option>
                                                @endforeach
