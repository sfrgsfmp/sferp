...
<div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong>@yield('content_title_active','Create Purchase Order for Raw Material')</strong>
        </li>
    </ol>
</div>
<div class="col-lg-2">
        ...
        <div class="ibox-content">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li><a class="nav-link {{ request()->is('po/detail') ? 'active' : null }}" href="{{ url('po/detail') }}" >Detail</a></li>
                    <li><a class="nav-link {{ request()->is('po/condition') ? 'active' : null }}" href="{{ url('po/condition') }}" >Purchase Order Condition</a></li>
                </ul>
                <div class="tab-content">
                    <div id="{{ url('po') }}" class="tab-pane {{ request()->is('po') ? 'active' : null }}">
                        <div class="panel-body">
                            <form action="{{ route('po.store')}}" id="act" method="POST">
                            @csrf 
                                <div class="row">        
                                    <div class="col-sm-9">
                                        <!-- //select ipl -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="code form-control @error('code') is-invalid @enderror" id="code" name="code">
                                                @error('code')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="chosen-select form-control @error('bankaccount') is-invalid @enderror" id="bankaccount" name="bankaccount"> 
                                                    <option value="">Choose</option> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control @error('type') is-invalid @enderror" id="type_" name="type" readonly>
                                                    @error('type')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 text-center">
                                        ...
                                        <button class="btn btn-primary btn-sm" type="submit" id="savegeneral" onclick="getcode()">Save</button>
                    ...
                    <!-- //DETAIL -->
                    <div id="{{ url('po/detail') }}" class="tab-pane {{ request()->is('po/detail') ? 'active' : null }}">
                        <div class="panel-body">
                                    ...
                                    <div class="col-sm-6 b-r">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <input type="hidden" class="form-control @error('species') is-invalid @enderror" id="species_id" name="species_id" readonly>

                                                <input type="text" class="form-control" name="speciessname" id="speciessname" readonly>
                                                @error('species')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="chosen-select form-control @error('sortimen') is-invalid @enderror" id="sortimen" name="sortimen"> 
                                                    <option value="">Choose</option>
                                                    @foreach($sortimens as $sortimen)
                                                        <option value="{{$sortimen->id}}"> {{$sortimen->code}}</option>
                                                    @endforeach
                                                </select>
                                                @error('sortimen')
                                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div id="{{ url('po/condition') }}" class="tab-pane {{ request()->is('po/condition') ? 'active' : null }}">
                        <div class="panel-body">
            ...
            if(ba_id)
            {
                ...
                $.ajax({
                    ...
                    success: function(datas){
                        ...
                        console.log(datas);
                        $('#bank_id').val(datas[0]);
                        $('#accountno').val(datas[1]);
                        $('#accountname').val(datas[2]);
                    }
                })
            }
        })
