        ...
        <div class="ibox-content">
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a class="nav-link active" data-toggle="tab" href="#tab-3" id="tab3">Purchase Order Condition</a></li>
                </ul>
                <div class="tab-content">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" id="hei_allowence" name="hei_allowence"  class="form-control @error('hei_allowence') is-invalid @enderror">
                                                @error('hei_allowence')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" id="wid_allowence" name="wid_allowence"  class="form-control @error('wid_allowence') is-invalid @enderror">
                                                @error('wid_allowence')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                    ...
                    <div id="tab-3" class="tab-pane active">
                        <div class="panel-body">
                            <form action="{{ route('po.updatecondition', ['pocs' => $pocs->id])}}" method="POST">
                            @csrf 
                                <div class="row">        
                                    <div class="col-sm-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <option value=""> Number PO</option>
                                                    @foreach($pos as $po)
                                                        <option value="{{$po->code}}" {{ $po->code == $pocs->code_po ? 'selected':''}}> {{$po->code}} </option>
                                                    @endforeach
                                                </select>
                                                @error('codeid')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control @error('trucking') is-invalid @enderror" id="trucking" name="trucking" value="{{$pocs->trucking}}">
                                                @error('trucking')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-sm-4">
                                                <select id="unit_trucking" name="unit_trucking" class="form-control @error('unit_trucking') is-invalid @enderror" value="{{$pocs->unit_trucking}}">
                                                    @foreach($measu as $mea)
                                                        <option value="{{$mea->id}}"> {{$mea->measurement_name}} </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 b-r">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                    <input type=text class="form-control @error('sort_min') is-invalid @enderror" id="sort_min" name="sort_min" value="{{$pocs->sort_min}}">
                                                    @error('sort_min')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('sort_max') is-invalid @enderror" id="sort_max" name="sort_max" value="{{$pocs->sort_max}}">
                                                    @error('sort_max')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                    <input type=text class="form-control @error('dia_min') is-invalid @enderror" id="dia_min" name="dia_min" value="{{$pocs->dia_min}}">
                                                    @error('dia_min')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('dia_max') is-invalid @enderror" id="dia_max" name="dia_max" value="{{$pocs->dia_max}}">
                                                    @error('dia_max')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                    <input type=text class="form-control @error('length_min') is-invalid @enderror" id="length_min" name="length_min" value="{{$pocs->length_min}}">
                                                    @error('length_min')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('length_max') is-invalid @enderror" id="length_max" name="length_max" value="{{$pocs->length_max}}">
                                                    @error('length_max')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                    <input type=text class="form-control @error('M3_min') is-invalid @enderror" id="M3_min" name="M3_min" value="{{$pocs->M3_min}}">
                                                    @error('M3_min')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('M3_max') is-invalid @enderror" id="M3_max" name="M3_max" value="{{$pocs->M3_max}}">
                                                    @error('M3_max')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                <input type=text class="form-control @error('dia_value_min') is-invalid @enderror" id="dia_value_min" name="dia_value_min" value="{{$pocs->dia_value_min}}">
                                                    @error('dia_value_min')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('dia_value_max') is-invalid @enderror" id="dia_value_max" name="dia_value_max" value="{{$pocs->dia_value_max}}">
                                                    @error('dia_value_max')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-daterange input-group" >
                                                    <input type=text class="form-control @error('length_value_min') is-invalid @enderror" id="length_value_min" name="length_value_min" value="{{$pocs->length_value_min}}">
                                                    ...
                                                    @enderror
                                                    <span class="input-group-addon">-</span>
                                                    <input type=text class="form-control @error('length_value_max') is-invalid @enderror" id="length_value_max" name="length_value_max" value="{{$pocs->length_value_max}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type=text class="form-control @error('value_type') is-invalid @enderror" id="value_type" name="value_type" value="{{$pocs->value_type}}">
                                                @error('value_type')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type=text class="form-control @error('value') is-invalid @enderror" id="value" name="value" value="{{$pocs->value}}">
                                                @error('value')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
