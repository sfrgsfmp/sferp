    ...
    <div class="ibox-content">
        ...
        <div class="tabs-container">
            ...
            <div class="tab-content">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="footable table-bordered toggle-arrow-tiny dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{ implode(',', $r->hph()->get()->pluck('code_hph')->toArray()) }} </td>
                                        <td> {{ $r->code}}</td>
                                        <td> {{ $r->applydate }}</td>
                ...
                <div id="{{ url('receipt/hph/info') }}" class="tab-pane {{ request()->is('receipt/hph/info') ? 'active' : null }}">
                    <div class="panel-body">
                        <span id="result"></span>
                        <div class="row">        
                            <div class="col-sm-6 b-r">
                ...
                <div id="{{ url('receipt/hph/vendor') }}" class="tab-pane {{ request()->is('receipt/hph/vendor') ? 'active' : null }}">
                    <div class="panel-body">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">No Receipt HPH </label>
                            <div class="col-sm-9">
                                <div class="input-group">
                        ...
                        <button class="btn btn-primary btn-outline" type="button" id="export_vendorreceipt" value="">Export</button>

                        <form action="{{ route('receipt.hph.importvendor') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="import_vendor" >
                ...
                <div id="{{ url('receipt/hph/graderout') }}" class="tab-pane {{ request()->is('receipt/hph/graderout') ? 'active' : null }}">
                    <div class="panel-body">
                        <div class="form-group row">
                        ...
                        <button class="btn btn-primary btn-xs btn-outline" type="button" id="export_graderout" value="">Export</button>

                        <form action="{{ route('receipt.hph.importgraderout') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="import_graderout" >
                ...
                <div id="{{ url('receipt/hph/graderin') }}" class="tab-pane {{ request()->is('receipt/hph/graderin') ? 'active' : null }}">
                    <div class="panel-body">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">No Receipt Log </label>
                            <div class="col-sm-9">
                        ...
                        <button class="btn btn-primary btn-xs btn-outline" type="button" id="export_graderin" value="">Export</button>

                        <form action="{{ route('receipt.hph.importgraderin') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="import_graderin" >
                            <input type="submit" class="btn btn-primary btn-xs btn-outline" value="Import">
                        </form>
                        <br>
                ...
                <div id="{{ url('receipt/hph/document') }}" class="tab-pane {{ request()->is('receipt/hph/document') ? 'active' : null }}">
                    <div class="panel-body">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">No Receipt Log </label>
                            <div class="col-sm-9">
                        ...
                        <button class="btn btn-primary btn-xs btn-outline" type="button" id="export_document" value="">Export</button>

                        <form action="{{ route('receipt.hph.importdocument') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="import_document" >
                            <input type="submit" class="btn btn-primary btn-outline btn-xs" value="Import">
                        </form>
                        <br>
                    </div>
                    <div class="panel-body">
                ...
                <div id="{{ url('receipt/hph/external') }}" class="tab-pane {{ request()->is('receipt/hph/external') ? 'active' : null }}">
                    <div class="panel-body">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">No Receipt Log </label>
                            <div class="col-sm-9">
                ...
                <div id="{{ url('receipt/hph/invoicing') }}" class="tab-pane {{ request()->is('receipt/hph/invoicing') ? 'active' : null }}">
